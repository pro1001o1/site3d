                ...
                <div class="hamburger-menu">
                    ...
                    <ul class="menu__box">
                        ...
                        <div class = "toform2">
                            ...
                            <input type = "email" name = "email" class = "form-control" placeholder="Email" required pattern = "[^@\s]+@[^@\s]+\.[^@\s]+" style = "width: 280px;height: 36px;margin-left: 40px;font-family: Segoe UI;font-style: normal;font-weight: normal;font-size: 12px;line-height: 16px;border-radius:1px solid #B8B8B8;border-radius:18px;">
                            <input type = "text" name = "name" class = "form-control" placeholder="Логин" required pattern="[А-Я]{1}[а-я]{1,15}" title = "Заглавная и строчные буквы русского алфавита,максимум-16 символов" style = "margin-top:16px;width: 280px;height: 36px;margin-left: 40px;font-family: Segoe UI;font-style: normal;font-weight: normal;font-size: 12px;line-height: 16px;border-radius:1px solid #B8B8B8;border-radius:18px;">
                            <?php

                            ?>
                            <input type = "text" name = "login" class = "form-control" placeholder="Имя профиля" required pattern = "[A-Z]{1}[A-Za-z0-9]{1,9}" title = "Заглавная,а также строчные буквы латинского алфавита и цифры,9 символов" style = "
                            ...
                            ?>
                            <button class="btn" type = "submit" style = "width: 280px;height: 36px;left: 40px;top: 305px;background: #F6CE3A;box-shadow: 2px 2px 6px rgba(0, 0, 0, 0.25);border-radius: 18px;font-family: Segoe UI;font-style: normal;font-weight: normal;font-size: 12px;line-height: 12px;color: black;text-transform: uppercase;">Зарегистрироваться</button>
                            </form>
                        </div>
                    </div>
                    </ul>
