<form action = "php_files/check_modal_projects_easy.php" method = "POST">
        <label for="customRange2" class="form-label">Количество помещений</label>
        <input type="range" class="form-range" min="1" max="10" id="houses1" value = "1" oninput="fun1()" name = "houses1">
        <label for="customRange2" class="form-label">Количество квадратных метров</label>
        <input type="range" class="form-range" min="30" max="200" id="squaremeters1" value = "30" oninput="fun1()" name = "squaremeters1">
        ...
        <p id = "vyvod_house1" style = "margin-left:190px;margin-top:-40px;">1</p>
        <p>Количество квадратных метров: </p>
        <p id = "vyvod_sqmeters1" style = "margin-left:250px;margin-top:-40px;">30</p>
        <p>Срок выполнения: </p>
        <p id = "srok1" style = "margin-left:150px;margin-top:-40px;">3</p>
        <p style = "margin-left:170px;margin-top:-40px">дней(-ня)</p>
        <p>Общая стоимость: </p>
        <p id = "price1" style = "margin-left:150px;margin-top:-40px;">30000</p>
