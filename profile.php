...
$log_prof = $_SESSION['login'];
$query_log_profile = "SELECT login FROM users WHERE login = '$log_prof'";
$result_log_profile = mysqli_query($link,$query_log_profile);
$log_vyvod_profile = mysqli_fetch_row($result_log_profile);
$vyvod_log_profile = $log_vyvod_profile[0]; 
?>
...
<!DOCTYPE html>
    <head>
        ...
        <script src = "scripts/avatar_show.js" type = "text/javascript"></script>
    </head>
    <body>
        ...
        <div class="hamburger-menu">
            ...
            <ul class="menu__box">
                <div class = "toform_back">
                    <div class = "toform3">
                    <form method = "POST" class = "form-auth" align = "center" action = "php_files/profile.php" enctype = "multipart/form-data">
                        <img src = "img/profile_pic.png" id = "avatar"/>
